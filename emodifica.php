...
if($email==$conf_email){
	...
	if($risultato_email===false){
		$mysqli->close();
		header("Location: settingsAzienda.php?err=1");//email gi� esistente
		exit;
		}
	}
}
...
if (!$foto_field['FOTO']) {  //Se il campo foto � vuoto, lo inserisco con il nome dell'immagine, ossia id.jpg
